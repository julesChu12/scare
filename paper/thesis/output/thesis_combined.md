...
**【请插入图片：fig5-1-jwt-flow.png — 图5-4 JWT认证流程图】**
...
**【请插入图片：fig5-4-request-sequence.png — 图5-1 需求提交时序图】**
...
**【请插入图片：fig5-3b-raycast-flow.png — 图5-2 围栏匹配算法流程图】**
...
**【请插入图片：fig5-3-raycast-principle.png — 图5-3 射线法原理示意图】**
...
**【请插入图片：fig5-2-task-claim.png — 图5-5 任务认领时序图】**
...
<!--
TODO 素材清单：
1. 图5-1 需求提交时序图 → fig5-4-request-sequence.png
2. 图5-2 围栏匹配算法流程图 → fig5-3b-raycast-flow.png
3. 图5-3 射线法原理示意图 → fig5-3-raycast-principle.png
4. 图5-4 JWT认证流程图 → fig5-1-jwt-flow.png
5. 图5-5 任务认领时序图 → fig5-2-task-claim.png
