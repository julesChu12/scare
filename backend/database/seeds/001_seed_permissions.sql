...
-- 数据中心
INSERT INTO `permissions` (`id`, `code`, `name`, `description`, `module`, `type`, `parent_id`, `api_path`, `api_method`, `is_public`, `status`, `sort`) VALUES
(63, 'data', '数据中心', '数据统计与报表模块', 'data', 'menu', 0, '', '', 0, 'active', 25),
(64, 'data:statistics', '统计分析', '统计分析', 'data', 'menu', 63, '', '', 0, 'active', 1),
(65, 'data:statistics:view', '查看统计', '查看统计数据', 'data', 'button', 64, '/api/v1/b/statistics/*', 'GET', 0, 'active', 1),
(66, 'data:report', '报表管理', '报表管理', 'data', 'menu', 63, '', '', 0, 'active', 2),
(67, 'data:report:list', '报表列表', '查看报表列表', 'data', 'button', 66, '/api/v1/b/reports', 'GET', 0, 'active', 1),
(68, 'data:report:generate', '生成报表', '生成报表', 'data', 'button', 66, '/api/v1/b/reports/generate', 'POST', 0, 'active', 2),
(69, 'data:report:download', '下载报表', '下载报表', 'data', 'button', 66, '/api/v1/b/reports/*/download', 'GET', 0, 'active', 3),
(70, 'data:report:delete', '删除报表', '删除报表', 'data', 'button', 66, '/api/v1/b/reports/*', 'DELETE', 0, 'active', 4);
...
-- staff 角色权限 (13条)
INSERT INTO `role_permissions` (`role_id`, `permission_id`) VALUES
(3, 10), (3, 11), (3, 12), (3, 13), (3, 14), (3, 15), (3, 17), (3, 18), (3, 19),
(3, 63), (3, 64), (3, 65), (3, 73);
