...
(0, '社区养老服务中心正式启动', 'https://via.placeholder.com/750x300/4A90E2/FFFFFF?text=养老服务中心', 'news', '1', 10, 'active'),
(0, '智慧养老新模式', 'https://via.placeholder.com/750x300/50C878/FFFFFF?text=智慧养老', 'news', '2', 9, 'active'),
(0, '志愿者定期上门探访', 'https://via.placeholder.com/750x300/FF6B6B/FFFFFF?text=志愿服务', 'url', 'https://example.com', 8, 'active'),
(1, '霍营站特色服务', 'https://via.placeholder.com/750x300/9B59B6/FFFFFF?text=霍营站', 'none', NULL, 7, 'active'),
(2, '龙泽站活动预告', 'https://via.placeholder.com/750x300/3498DB/FFFFFF?text=龙泽站', 'none', NULL, 6, 'active');

SELECT '轮播图数据' AS 'Table', COUNT(*) AS 'Count' FROM `banners` WHERE `deleted_at` IS NULL;
