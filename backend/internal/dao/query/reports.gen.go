...
func newReport(db *gorm.DB, opts ...gen.DOOption) report {
	...
	_report.Format = field.NewString(tableName, "format")
	_report.FilePath = field.NewString(tableName, "file_path")
	_report.FileSize = field.NewInt64(tableName, "file_size")
	_report.StationID = field.NewInt64(tableName, "station_id")
	_report.StartDate = field.NewTime(tableName, "start_date")
	_report.EndDate = field.NewTime(tableName, "end_date")
	_report.CreatedBy = field.NewInt64(tableName, "created_by")
...
type report struct {
	...
	Name      field.String // æŠ¥è¡¨åç§°
	Type      field.String // æŠ¥è¡¨ç±»åž‹ï¼šservice/performance/request/station
	Format    field.String // æ–‡ä»¶æ ¼å¼ï¼šxlsx/csv
	FilePath  field.String // æ–‡ä»¶å­˜å‚¨è·¯å¾„
	FileSize  field.Int64  // æ–‡ä»¶å¤§å°ï¼ˆå­—èŠ‚ï¼‰
	StationID field.Int64  // ç«™ç‚¹IDï¼ŒNULLè¡¨ç¤ºå…¨å±€
	StartDate field.Time   // ç»Ÿè®¡å¼€å§‹æ—¥æœŸ
	EndDate   field.Time   // ç»Ÿè®¡ç»“æŸæ—¥æœŸ
	CreatedBy field.Int64  // åˆ›å»ºäººID
...
func (r *report) updateTableName(table string) *report {
	...
	r.StationID = field.NewInt64(table, "station_id")
