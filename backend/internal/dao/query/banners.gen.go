...
func newBanner(db *gorm.DB, opts ...gen.DOOption) banner {
	...
	_banner.StationID = field.NewInt64(tableName, "station_id")
	...
	_banner.LinkValue = field.NewString(tableName, "link_value")
	_banner.Sort = field.NewInt32(tableName, "sort")
	_banner.Status = field.NewString(tableName, "status")
...
type banner struct {
	...
	LinkType  field.String // è·³è½¬ç±»åž‹(none/news/url)
	LinkValue field.String // è·³è½¬å€¼(æ–°é—»IDæˆ–URL)
	Sort      field.Int32  // æŽ’åº(æ•°å­—è¶Šå¤§è¶Šé å‰)
	Status    field.String // çŠ¶æ€(active/inactive)
	CreatedAt field.Time   // åˆ›å»ºæ—¶é—´
	UpdatedAt field.Time   // æ›´æ–°æ—¶é—´
	DeletedAt field.Field  // åˆ é™¤æ—¶é—´(è½¯åˆ é™¤)
