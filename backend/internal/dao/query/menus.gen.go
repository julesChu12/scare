...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.PermissionCode = field.NewString(tableName, "permission_code")
...
type menu struct {
	...
	ParentID       field.Int64  // çˆ¶èœå•IDï¼Œ0è¡¨ç¤ºé¡¶çº§èœå•
	Name           field.String // èœå•åç§°
	Path           field.String // è·¯ç”±è·¯å¾„
	Component      field.String // å‰ç«¯ç»„ä»¶è·¯å¾„
	Icon           field.String // å›¾æ ‡åç§°
	PermissionCode field.String // æƒé™ç ï¼Œæ ¼å¼: module:resource:action
	Sort           field.Int32  // æŽ’åºå€¼ï¼Œæ•°å­—è¶Šå°è¶Šé å‰
	Hidden         field.Bool   // æ˜¯å¦éšè— 0-æ˜¾ç¤º 1-éšè—
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.PermissionCode = field.NewString(table, "permission_code")
...
func (m *menu) fillFieldMap() {
	...
	m.fieldMap["permission_code"] = m.PermissionCode
